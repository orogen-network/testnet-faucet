...
Per RFC-0009 (operator registration with sanctions + attestation proof). Anti-sybil ties into the same axes used by `pallet-operator-stake` registration: device cert + geo region + IP /24 hash.
